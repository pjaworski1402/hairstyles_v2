...
const PrivacyPolicy = () => {
  return (
    <div style={{ margin: "5%", fontFamily: "Roboto" }}>
      <h1>
        <strong>Privacy Policy of hairstyles-gta5.com</strong>
      </h1>
      <p>&nbsp;</p>
      <p>
        Our website address is:&nbsp;
        <a href="https://hairstyles-gta5.com/">https://hairstyles-gta5.com/</a>
      </p>
      <p>
      ...
      <p>
        You can also help us to protect your personal data by adhering to the
        following security measures:
      </p>
      <p>
        Do not confirm your bank or credit card details in an email. We will not
        ask for such personal data in this way, so any email claiming to be from
        us that does so is likely to be a fake. Please ignore it.
      </p>
      <h2>
