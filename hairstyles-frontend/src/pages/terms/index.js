...
const TermsAndConditions = () => {
  return (
    <div style={{ margin: "5%", fontFamily: "Roboto" }}>
      <h1>
      ...
      <ul>
        ...
        <li>
          <strong>Website</strong>&nbsp;refers to hairstyles-gta5.com,
          accessible from&nbsp;
          <a href="https://hairstyles-gta5.com/">
            https://hairstyles-gta5.com/
          </a>
        </li>
        <li>
      ...
      <p>
        ...
        the customer, and hairstyles-gta5 (&ldquo;us&rdquo;, &ldquo;we&rdquo;),
        governing the use of our website and game-related products, items and
        other content the content therein (&ldquo;Products&rdquo;). Your use of
        our website, and purchase, download and use of our products, constitutes
        your full acceptance of these terms and conditions. If you do not agree
        with these terms and conditions, you should not use our website,
        purchase, download or use any of our products.
      </p>

      <h3>
        <strong>2. License and Use</strong>
      </h3>

      <p>
        Your purchase of one of our products constitutes our granting to you of
        a non-exclusive, non-sublicensable, non-transferable license to download
        and access that product for the purpose of your own personal use. You
        agree that under no circumstances shall you use, or permit to be used,
        any product other than for the aforesaid purpose. For the avoidance of
        doubt, you shall not copy, re-sell, share or otherwise distribute any of
        our products, whether modified or not, to any third party. You agree not
        to use any of our products in a way which might be detrimental to us or
        damage our reputation.
      </p>

      <h3>
        <strong>3. Orders and Contracts of Sale</strong>
      </h3>

      <ol type="a">
        <li>
          The products shown on hairstyles-gta5.com are part of a online
          catalogue;
        </li>
        <li>
          When you place an order on hairstyles-gta5.com you will be asked to
          confirm your order when you reach the final step of the ordering
          process.
        </li>

        <li>
          Your order will be shipped to the e-mail you provided us with when you
          placed your order, after your payment is received
        </li>

        <li>
          If payment is not successful, the order will automatically be
          cancelled
        </li>
      </ol>
      <h3>
      ...
      <p>
        Service does not bear any responsibility for incorrect use of the
        products.
      </p>
      <h3>
      ...
      <h3>
        <strong>10 .Refunds and Chargebacks</strong>
      </h3>
      <p>
        Because we sell digital products so once a product has been purchased by
        you, no right of cancellation or refund. Any refunds shall be at our
        sole and absolute discretion. You agree that under no circumstances
        whatsoever shall you initiate any chargebacks via your payment provider.
        You agree that any payments made by you for any of our products are
        final and may not be charged back. We reserve the right to alter any of
        our prices from time to time.
      </p>
      <h3>
      ...
      <h3>
        <strong>12. Changes to These Terms and Conditions</strong>
      </h3>
      <p>
      ...
      <h3>13. Privacy and Security</h3>
      <p>
        hairstyles-gta5.com takes privacy very seriously and shall never sell,
        share, or otherwise disclose any of your personal information to anyone.
        Information that is collected upon sign up is used only to enhance your
        experience on the Site and for troubleshooting purposes. The principles
        of the personal data process are set forth in&nbsp;Privacy Policy.
      </p>
      <h3>14. Other Terms</h3>
      <p>
        hairstyles-gta5.com reserves the right at any time to modify, suspend or
        terminate the services (or any part thereof) provided at the Site,
        and/or your use of or access to them, with or without notice.
        hairstyles-gta5.com may also delete, or bar access to or use of, all
        related information and files. hairstyles-gta5.com will not be liable to
        you or any third-party for any modification, suspension, or termination
        of the Services, or loss of related information.
      </p>
      <h3>
      ...
      <ul>
        <li>
          By email:&nbsp;
          <a href="mailto:hairstyles.gta5@gmail.com">
            hairstyles.gta5@gmail.com
          </a>
        </li>
        <li>
          By contact form -&nbsp;
